...
-- Risk: empresas futuras cujo razao_social/nome contenha 'piscina' também serão habilitadas.
...
-- Habilita os 2 novos tipos (NF-e e NFC-e) para a AL Piscinas (match por razão social — evita hardcode de UUID/CNPJ).

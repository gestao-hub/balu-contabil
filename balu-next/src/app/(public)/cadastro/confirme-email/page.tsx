      ...
      <div className="bg-surface rounded-2xl shadow-sm border border-border p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Enviamos um link de confirmação{email ? <> para <strong className="text-muted-foreground-2">{email}</strong></> : ''}.
            Clique no link para ativar sua conta.
          </p>
        </div>

        <div className="rounded-lg bg-surface-2 border border-border px-4 py-3 text-xs text-muted-foreground-2 space-y-1">

...
- **Create** `balu-next/vitest.config.ts` — config do Vitest escopada a `src/**/*.test.ts` (não colide com os specs Playwright em `tests/`).
- **Create** `balu-next/src/lib/fiscal/regime.ts` — option sets + helpers puros + `normalizeRegimePatch`.
- **Create** `balu-next/src/lib/fiscal/regime.test.ts` — testes unitários dos helpers.
- **Modify** `balu-next/src/types/zod.ts` — adicionar `EmpresaFiscalSchema` + `EmpresaFiscalInput`.
- **Create** `balu-next/src/types/zod.test.ts` — testes do schema.
- **Modify** `balu-next/src/app/(auth)/configuracoes/actions.ts` — adicionar `upsertEmpresaFiscalAction`.
- **Create** `balu-next/src/app/(auth)/configuracoes/RegimeTributarioForm.tsx` — form client.
- **Modify** `balu-next/src/app/(auth)/configuracoes/page.tsx` — renderizar o form na aba `regime`.
...
**Files:**
- Create: `balu-next/vitest.config.ts`
- Create: `balu-next/src/lib/fiscal/regime.ts`
- Test: `balu-next/src/lib/fiscal/regime.test.ts`
...
Create `balu-next/src/lib/fiscal/regime.test.ts`:
...
```bash
git add balu-next/vitest.config.ts "balu-next/src/lib/fiscal/regime.ts" "balu-next/src/lib/fiscal/regime.test.ts"
...
Create `balu-next/src/types/zod.test.ts`:
...
Em `balu-next/src/types/zod.ts`, ao final do arquivo (depois de `HonorarioSchema`/`HonorarioInput`), acrescente:
...
No topo de `balu-next/src/app/(auth)/configuracoes/actions.ts`, junto dos imports existentes, adicione:
...
Acrescente ao final de `balu-next/src/app/(auth)/configuracoes/actions.ts`:
...
**Files:**
- Create: `balu-next/src/app/(auth)/configuracoes/RegimeTributarioForm.tsx`
...
```bash
git add "balu-next/src/app/(auth)/configuracoes/RegimeTributarioForm.tsx"
...
Em `balu-next/src/app/(auth)/configuracoes/page.tsx`, junto do import de `DadosEmpresaForm`:

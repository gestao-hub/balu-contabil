...
- **Create** `app/src/lib/fiscal/certificado.ts` — `validateCertificadoUpload` (puro).
- **Create** `app/src/lib/fiscal/certificado.test.ts` — testes do validador.
- **Modify** `app/src/app/(auth)/configuracoes/actions.ts` — `uploadCertificadoAction`.
- **Create** `app/src/app/(auth)/configuracoes/CertificadoForm.tsx` — form (client).
- **Modify** `app/src/app/(auth)/configuracoes/page.tsx` — status + render na aba `certificado`.

Comandos rodam de `app/`. Branch: `feat/pr-1.6-certificado`.
...
**Files:**
- Create: `app/src/lib/fiscal/certificado.ts`
- Test: `app/src/lib/fiscal/certificado.test.ts`

- [ ] **Step 1: Escrever o teste (falhando)**

Create `app/src/lib/fiscal/certificado.test.ts`:
...
```bash
git add "app/src/lib/fiscal/certificado.ts" "app/src/lib/fiscal/certificado.test.ts"
...
**Files:**
- Create: `app/src/app/(auth)/configuracoes/CertificadoForm.tsx`

...
- **Create** `balu-next/src/lib/fiscal/municipio-nfse.ts` — helpers puros: `normalizeNome`, `credenciaisDaAutenticacao`.
- **Create** `balu-next/src/lib/fiscal/municipio-nfse.test.ts` — testes dos helpers.
- **Create** `balu-next/src/lib/fiscal/municipio-nfse.server.ts` — `resolveMunicipioNfse` (`server-only`).
- **Modify** `balu-next/src/types/zod.ts` — estender `EmpresaFiscalSchema` com campos NFS-e.
- **Modify** `balu-next/src/types/zod.test.ts` — testes dos campos NFS-e.
- **Modify** `balu-next/src/app/(auth)/configuracoes/actions.ts` — tweak no `upsertEmpresaFiscalAction`.
- **Create** `balu-next/src/app/(auth)/configuracoes/NfseForm.tsx` — form da aba (client).
- **Modify** `balu-next/src/app/(auth)/configuracoes/page.tsx` — resolver município + renderizar na aba `nfse`.

Todos os comandos rodam de `balu-next/`. Branch: `feat/pr-1.5-nfse`.
...
**Files:**
- Create: `balu-next/src/lib/fiscal/municipio-nfse.ts`
- Test: `balu-next/src/lib/fiscal/municipio-nfse.test.ts`

- [ ] **Step 1: Escrever o teste (falhando)**

Create `balu-next/src/lib/fiscal/municipio-nfse.test.ts`:
...
```bash
git add "balu-next/src/lib/fiscal/municipio-nfse.ts" "balu-next/src/lib/fiscal/municipio-nfse.test.ts"
...
**Files:**
- Modify: `balu-next/src/types/zod.ts`
- Test: `balu-next/src/types/zod.test.ts`

- [ ] **Step 1: Adicionar testes (falhando)**

Em `balu-next/src/types/zod.test.ts`, ao final do arquivo, acrescente:
...
Em `balu-next/src/types/zod.ts`, dentro de `EmpresaFiscalSchema`, **logo após** a linha `cnae_principal: ...` e **antes** do `});`, adicione:
...
```bash
git add "balu-next/src/types/zod.ts" "balu-next/src/types/zod.test.ts"
...
**Files:**
- Create: `balu-next/src/lib/fiscal/municipio-nfse.server.ts`
...
Em `balu-next/src/app/(auth)/configuracoes/actions.ts`, troque a linha:
...
```bash
git add "balu-next/src/lib/fiscal/municipio-nfse.server.ts" "balu-next/src/app/(auth)/configuracoes/actions.ts"
...
**Files:**
- Create: `balu-next/src/app/(auth)/configuracoes/NfseForm.tsx`
...
Em `balu-next/src/app/(auth)/configuracoes/page.tsx`, junto dos imports de forms:

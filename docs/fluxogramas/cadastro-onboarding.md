...
flowchart TD
    ...
    B --> C{"Validação\nclient + server"}
    C -->|erro| B["Preenche nome, tipo de conta,\ne-mail, senha + aceita termos"]
    ...
    J["Redireciona para /"]
    H --> J["Redireciona para /"]
    I --> J["Redireciona para /"]
    J --> K{"Auth layout gate\nverifica sessão e empresa"}
    ...
    O --> Q["Etapa 1: digita CNPJ\nbusca na Focus API\nautofill razão social, endereço, CNAE, regime"]
